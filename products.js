const products = [
    ...
    },
    {
      ...
      {
        id: 9,
        title: "Men Simple Tay Son T-Shirt",
        price: "$40",
        description: "Lorem ipsum dolor sit amet consectetur, adipisicing elit. Totam laborum aut explicabo molestias voluptas, eum nulla doloremque laboriosam. Accusantium omnis illum nulla architecto doloribus.",
        colors: [
            {
                name: "Black",
                mainImage: "images/product9_black.jpg",
                thumbnails: [],
                sizes: ["S", "M", "L", "XL", "XXL"]
            },
            {
                name: "white",
                mainImage: "images/product_9_white.jpg",
                thumbnails: [],
                sizes: ["S", "M", "L", "XL", "XXL"]
            }
        ]
     ...
     {
        id: 10,
        title: "Men Soft lavender T-Shirt",
        price: "$49",
        description: "Lorem ipsum dolor sit amet consectetur, adipisicing elit. Totam laborum aut explicabo molestias voluptas, eum nulla doloremque laboriosam. Accusantium omnis illum nulla architecto doloribus.",
        colors: [
            {
                name: "Purple",
                mainImage: "images/product10_purple.png",
                thumbnails: [],
                sizes: ["S", "M", "L", "XL", "XXL"]
            }
        ]
     ...
     {
        id: 11,
        title: "Clean and minimal T-Shirt",
        price: "$30",
        description: "Lorem ipsum dolor sit amet consectetur, adipisicing elit. Totam laborum aut explicabo molestias voluptas, eum nulla doloremque laboriosam. Accusantium omnis illum nulla architecto doloribus.",
        colors: [
            {
                name: "Purple",
                mainImage: "images/product_white_1.png",
                thumbnails: [],
                sizes: ["S", "M", "L", "XL", "XXL"]
            }
        ]
     ...
     {
        id: 12,
        title: "Cool blue T-Shirt crafted",
        price: "$60",
        description: "Lorem ipsum dolor sit amet consectetur, adipisicing elit. Totam laborum aut explicabo molestias voluptas, eum nulla doloremque laboriosam. Accusantium omnis illum nulla architecto doloribus.",
        colors: [
            {
                name: "Purple",
                mainImage: "images/product_blue_5.png",
                thumbnails: [],
                sizes: ["S", "M", "L", "XL", "XXL"]
            }
        ]
